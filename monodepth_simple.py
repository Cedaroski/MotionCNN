...
def test_simple(params):
    ...
    f.write(format(depth_img.max())+' '+format(depth_img.min()))
    f.close()
    '''
    ...
    f = open(os.path.join(output_directory, "{}_depth.txt".format(output_name)), 'w')
    ...
    #f = open("depth_max_min", 'w')
    plt.imsave(os.path.join(output_directory, "{}_depth.png".format(output_name)), depth_to_img, cmap='gray')
